module.exports = async d => {
	...
	if (!guild) return d.error(`:x: invalid guildID in \`$cacheMembers${inside.total}\``)
    ...
    return {
        code: code.replaceLast(`$cacheMembers${inside.total}`, returnCount.toLowerCase() === "yes" ? aft - prev : "")
    }
} 