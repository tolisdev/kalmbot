...
<input type="text" class="form-control w-100" name="name" id="name" placeholder="The name of the variable" value="<%= variable.name %>" required>
</div>
<div class="d-none">
...
<div class="mb-3">
<label for="value" class="form-label display-6">Variable Value:</label>
<textarea class="form-control " rows="1" name="value" id="value" placeholder="The value of the variable" required><%= variable.value ? variable.value : "" %></textarea>
</div>
<button class="btn btn-primary form-button" type="submit" style="width:20rem;">Save Variable</button>
<button class="btn btn-danger form-button" type="button" style="width:20rem;" onclick="AlertDelete('<%= variable.name %>')">Delete Variable</button>
